...
public class ModelResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Model> updateModel(@PathVariable(value = "id", required = false) final String id, @RequestBody Model model)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, model.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Model> partialUpdateModel(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, model.getId()));
    }
